...
export const LocationPinIcon: React.FC<IconProps> = ({ className = 'w-5 h-5' }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
export const InstagramIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg className={className} fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    <path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.85s-.011 3.584-.069 4.85c-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07s-3.584-.012-4.85-.07c-3.252-.148-4.771-1.691-4.919-4.919-.058-1.265-.069-1.645-.069-4.85s.011-3.584.069-4.85c.149-3.225 1.664-4.771 4.919-4.919C8.416 2.175 8.796 2.163 12 2.163zm0 1.442c-3.16 0-3.52.012-4.745.068-2.762.126-3.95 1.31-4.075 4.075-.056 1.225-.067 1.585-.067 4.745s.011 3.52.067 4.745c.126 2.762 1.31 3.95 4.075 4.075 1.225.056 1.585.067 4.745.067s3.52-.011 4.745-.067c2.762-.126 3.95-1.31 4.075-4.075.056-1.225.067-1.585.067-4.745s-.011-3.52-.067-4.745c-.126-2.762-1.31-3.95-4.075-4.075-1.225-.056-1.585-.068-4.745-.068zm0 4.228c-2.325 0-4.202 1.877-4.202 4.202s1.877 4.202 4.202 4.202 4.202-1.877 4.202-4.202-1.877-4.202-4.202-4.202zm0 6.844c-1.46 0-2.642-1.182-2.642-2.642s1.182-2.642 2.642-2.642 2.642 1.182 2.642 2.642-1.182 2.642-2.642 2.642zm4.492-6.88a1.002 1.002 0 11-2.004 0 1.002 1.002 0 012.004 0z"/>
  </svg>
);
